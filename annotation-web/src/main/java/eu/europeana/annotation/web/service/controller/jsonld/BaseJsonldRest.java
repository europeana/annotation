...
//			apRes.setCurrentPageUri("http://UNDEFINED");
	 ...
	 * @param identifier
	 * @param action
	 * @param searchProfileStr e.g. "dereference"
	 * @param language e.g. "en,pl,de,nl,fr,it,da,sv,el,fi,hu,cs,sl,et,pt,es,lt,lv,bg,ro,sk,hr,ga,mt,no,ca,ru"
	 * @return
	 * @throws HttpException
	 */
	protected ResponseEntity<String> getAnnotationById(String wsKey, String identifier, String action, String searchProfileStr, String language)
			throws HttpException {
