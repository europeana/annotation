...
public class SearchTextualBodyTest extends BaseSearchTest {
  ...
  @Test
  public void searchDescriptionBody() throws IOException, JsonParseException,
    ...
    String VALUE_DESCRIBING_TARGET_SCOPE_URI =
        ClientConfiguration.getInstance().getPropAnnotationItemDataEndpoint()
            + "/07931/diglit_uah_m1";
  ...
  private void validateDescriptionBody(Annotation storedAnno) {
    ...
    assertTrue(target.getScope()
        .equals(ClientConfiguration.getInstance().getPropAnnotationItemDataEndpoint()
            + "/07931/diglit_uah_m1"));
  }

  @Test
  public void searchTranscriptionBody() throws IOException, JsonParseException,
      IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    validateTranscriptionBody(retrievedAnno);
    String VALUE_SEARCH_TARGET_URI =
        "target_uri:\"" + ClientConfiguration.getInstance().getPropAnnotationItemDataEndpoint()
            + "/07931/diglit_uah_m1\"";
