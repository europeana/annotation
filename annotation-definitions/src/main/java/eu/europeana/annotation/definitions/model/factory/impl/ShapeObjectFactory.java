...
public class ShapeObjectFactory extends AbstractModelObjectFactory<Selector, SelectorTypes>{

	private static ShapeObjectFactory singleton;

	//force singleton usage
	private ShapeObjectFactory(){};
	
	public static ShapeObjectFactory getInstance() {

		if (singleton == null) {
			synchronized (ShapeObjectFactory.class) {
				singleton = new ShapeObjectFactory();
			}
		}
