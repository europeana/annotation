...
public class WhitelistValidationException extends RuntimeException{
	...
	public static final String ERROR_NAME_EXISTS = "Whitelist entry for the given name already exists. ";
	public static final String ERROR_NO_ENTRIES_FOUND_TO_DELETE = "No whitelist entry found for delete. ";
