...
public class MotivationObjectFactory extends AbstractModelObjectFactory<Selector, SelectorTypes>{

	private static MotivationObjectFactory singleton;

	//force singleton usage
	private MotivationObjectFactory(){};
	
	public static MotivationObjectFactory getInstance() {

		if (singleton == null) {
			synchronized (MotivationObjectFactory.class) {
				singleton = new MotivationObjectFactory();
			}
		}
