...
public class AnnotationSearchApiTest extends AbstractIntegrationTest {
	...
	public void testSearchAnnotationPaging() throws Exception {
	  ...
	  // first page
	  String query = "*:*";
	  AnnotationPage annPg = searchAnnotationsAddQueryField(query, null, null, null, null, SearchProfiles.MINIMAL, null);
	  ...
	  AnnotationPage lastPage = searchAnnotationsAddQueryField(query, Integer.toString(lastPageNum), Integer.toString(TOTAL_IN_PAGE), null, null, SearchProfiles.STANDARD, null);
