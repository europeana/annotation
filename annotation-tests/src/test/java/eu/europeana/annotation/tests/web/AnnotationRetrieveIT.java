...
public class AnnotationRetrieveIT extends AbstractIntegrationTest {
  ...
  public void dereferencedSemanticTag() throws Exception {
    ...
    ResponseEntity<String> response = getAnnotation(AnnotationTestsConfiguration.getInstance().getApiKey() ,storedAnno1.getIdentifier(), false, SearchProfiles.DEREFERENCE);
