...
public class WebAnnotationAuxilaryMethodsTest extends BaseAnnotationTest {
  ...
  public void getDeletedAnnotations() throws Exception {
    ...
    try {
      ...
      removeAnnotationManually(anno_tag.getIdentifier());
      removeAnnotationManually(anno_subtitle.getIdentifier());
    }
