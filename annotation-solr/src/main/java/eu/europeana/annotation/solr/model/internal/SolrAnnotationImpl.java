 ...
 *
 */
public class SolrAnnotationImpl extends AbstractAnnotation
    implements SolrAnnotation, SolrAnnotationConstants {
  ...
  private String findScenarioType(Annotation anno) {
    switch (anno.getMotivationType()) {
      ...
      case TAGGING:
        if (anno.getBody().getInternalType()
            .equalsIgnoreCase(BodyInternalTypes.SEMANTIC_TAG.toString())) {
          return AnnotationScenarioTypes.SEMANTIC_TAG;
        } else if (anno.getBody().getInternalType()
            .equalsIgnoreCase(BodyInternalTypes.TAG.toString())) {
          return AnnotationScenarioTypes.SIMPLE_TAG;
        } else if (anno.getBody().getInternalType()
            .equalsIgnoreCase(BodyInternalTypes.GEO_TAG.toString())) {
  ...
  @Override
  @Field(MOTIVATION) // setter is final, need to use the getter
  ...
  public String toString() {
    return "SolrAnnotation [anno_uri:" + getAnnoUri() + ", created:" + getCreated() + ", bodyValue:"
        + getBodyValue() + "]";
  }
